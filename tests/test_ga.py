...
def test_simplify():
    ...
    assert_simplified('div 0 $b', '0')
    assert_simplified('div $b 1', '$b')
    assert_simplified('pow $b 0', '1')
    assert_simplified('pow $b 1', '$b')
    assert_simplified('pow 0 $b', '0')
    assert_simplified('pow 0 0', '1.0')
    assert_simplified('pow 1 $b', '1')
